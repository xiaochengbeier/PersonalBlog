...
exports.resetPassTemplate = void 0;
function resetPassTemplate(code, name) {
    ...
    <body>
        ...
        <div>
            ...
            <p>您的重置密码验证码为：</p>
            <p><span class="button"><a >${code}</a></span> </p>
            <p>此链接有效期为 24 小时。 如果已过期，请尝试 请求新的验证电子邮件。.</p>
            <p>我们收到了使用您的电子邮件地址申请 重置密码的请求。如果您没有发出该请求，则请提交帮助请求 或发送电子邮件至littlecity@aliyun.com
                谢谢，</p>
        </div>
        <footer>
...
exports.resetPassTemplate = resetPassTemplate;
